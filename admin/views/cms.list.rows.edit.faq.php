    ...
    <div class="col-md-12">
        <div class="card my-0">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Linie : <?= (($_GET['edit']) ? 'Modifica' : 'Adauga' ) ?> FAQ</h4>
                </div>
            ...
            <div class="card-body px-3">
                ...
                <form method="POST" action="" id="<?= $formName ?>" enctype="multipart/form-data" class="form-horizontal my-4">
                    ...
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="title-row">Intrebare:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="text-row">Raspuns:</label>
                        <div class="col-sm-10">
                            <div class="form-group">
