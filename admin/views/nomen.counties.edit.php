    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Nomenclatoare > Judete : <?= (($_GET['edit']) ? 'Modifica' : 'Adauga' ) ?></h4>
                </div>
            </div>
            <div class="card-body px-3">
                ...
                <form method="POST" action="" id="editForm" enctype="multipart/form-data" class="form-horizontal my-4">
                    ...
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="code">Cod:</label>
                        <div class="col-sm-2">
                            <div class="form-group">
                                <input type="text" id="code" name="code" value="<?= $_POST['code'] ?>" class="form-control" maxlength="2" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
