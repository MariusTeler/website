    ...
    <div class="col-md-12">
        <div class="card my-0">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Linie : <?= (($_GET['edit']) ? 'Modifica' : 'Adauga' ) ?> Centre</h4>
                </div>
            ...
            <div class="card-body px-3">
                ...
                <form method="POST" action="" id="<?= $formName ?>" enctype="multipart/form-data" class="form-horizontal my-4">
                    ...
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="title-row">Localitate:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="centers_clients-row">Relatii clienti:</label>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <textarea id="centers_clients-row" name="metadata[centers_clients]" class="form-control"><?= $_POST['metadata']['centers_clients'] ?></textarea>
                            </div>
                        </div>
                        <label class="col-sm-2 col-form-label" for="centers_area-row">Responsabil zonal:</label>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <textarea id="centers_area-row" name="metadata[centers_area]" class="form-control"><?= $_POST['metadata']['centers_area'] ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="centers_email-row">Email:</label>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <textarea id="centers_email-row" name="metadata[centers_email]" class="form-control"><?= $_POST['metadata']['centers_email'] ?></textarea>
                            </div>
                        </div>
                        <label class="col-sm-2 col-form-label" for="centers_address-row">Adresa:</label>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <textarea id="centers_address-row" name="metadata[centers_address]" class="form-control"><?= $_POST['metadata']['centers_address'] ?></textarea>
                            </div>
                        </div>
                    </div>

                    <? parseVar('title', 'Harta', '@init.form.button') ?>
