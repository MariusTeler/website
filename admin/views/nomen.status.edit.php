    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Nomenclatoare > Status Contact : <?= (($_GET['edit']) ? 'Modifica' : 'Adauga' ) ?></h4>
                </div>
            </div>
            <div class="card-body px-3">
                ...
                <form method="POST" action="" id="editForm" enctype="multipart/form-data" class="form-horizontal my-4">
                    ...
                    <div class="row">
                        <label class="col-sm-2 col-form-label" for="color">Culoare:</label>
                        <div class="col-sm-10">
                            <div class="form-group">
                                <select id="color" name="color" class="custom-select custom-select-filter">
                                    <?= formSelectOptions(COLOR_TYPES, '', 'color', true) ?>
                                </select>
                            </div>
                        </div>
                    </div>
