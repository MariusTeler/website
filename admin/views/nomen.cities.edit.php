    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Nomenclatoare > Localitati : <?= (($_GET['edit']) ? 'Modifica' : 'Adauga' ) ?></h4>
                </div>
            </div>
            <div class="card-body px-3">
                ...
                <form method="POST" action="" id="editForm" enctype="multipart/form-data" class="form-horizontal my-4">
                    ...
                    <input type="hidden" id="county_id" name="county_id" value="<?= $_GET['county_id'] ?>" />
                    <div class="row">
                    ...
                    <div class="row">
                        <label class="col-3 col-sm-2 col-form-label" for="county_id">Judet:</label>
                        <div class="col-9 col-sm-10">
                            <label class="col-form-label text-secondary"><?= $county['name'] ?></label>
                        </div>
                    </div>
                    <div class="row">
