    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Continut > Blocuri : <?= (($_GET['edit']) ? 'Modifica' : 'Adauga' ) ?></h4>
                </div>
            </div>
            <div class="card-body px-3">
                ...
                <form method="POST" action="" id="editForm" enctype="multipart/form-data" class="form-horizontal my-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <select id="type" name="type" class="custom-select custom-select-filter" <?= $_GET['edit'] ? 'disabled' : '' ?>>
                                    <?= formSelectOptions(VARIOUS_TYPES, '', 'type', true) ?>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <? parseVar('entityType', ENTITY_VARIOUS, 'cms.box.entity') ?>
                    ...
                    <? parseVar('entityType', ENTITY_VARIOUS, 'user.actions') ?>
